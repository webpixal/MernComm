    ...
    <div className="w-full bg-white rounded-lg shadow-2xl dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
      <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form className="space-y-4 md:space-y-6" action="#">
          ...
          <div className="relative mb-8">
            <input onChange={(e) => setPassword(e.target.value)} value={password} id="email" name="email" type="text" className="w-full h-10 text-secoundery placeholder-transparent border-b-2 border-gray-300 peer focus:outline-none focus:border-primary" placeholder="••••••••" required />
